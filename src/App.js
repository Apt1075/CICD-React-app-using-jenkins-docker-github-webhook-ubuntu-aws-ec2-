...
const About = () => (
  <section className="p-6 text-center" id="about">
    ...
    <p className="text-gray-700 max-w-2xl mx-auto">
      This project was developed by ArpitKumar and demonstrates a complete CI/CD pipeline for a React single-page application. GitHub webhooks trigger Jenkins builds, which create Docker images, deploy the application, and send email notifications on build success or failure.
    </p>
  </section>
);
